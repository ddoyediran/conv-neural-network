...
// Input feature Array is a 2 dimensional
...
// model.add(tf.layers.dense({ inputShape: [784], unit: 32, activation: "relu" }));
...
async function train() {
  ...
  model.compile({
    ...
    loss: "categoricalCrossentropy", // Use for a classification problem
    metrics: ["accuracy"], // As this is a classification problem you can ask to record accuracy in the logs too!
  });
  ...
  let results = await model.fit(RESHAPED_INPUTS, OUTPUTS_TENSOR, {
    ...
    batchSize: 256, // Update weights after 512 examples
...
const DOM_SPEED = document.getElementById("domeSpeed");
